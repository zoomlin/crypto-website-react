...
const CalcForm = () => {
  return (
    <div className="w-full bg-white max-w-[942px] mx-auto rounded-2xl text-darkblue p-12 shadow-primary"           data-aos='fade-up'
          data-aos-offset='500'
>
      <form className="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-12 lg:space-y-0">
        ...
        <div className='mt-24'>
        <div className='text-blue font-medium mb-4'>ESTEMATED 24 HOUR REVENUE:</div>
