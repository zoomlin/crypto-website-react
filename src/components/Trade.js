...
const Trade = () => {
  const [itemName, setItemName] = React.useState('Bitcoin');
  return (
            ...
            return (
              ...
              >
                <div className="flex flex-col justify-center items-center">
                  ...
                  <button
                    className={`name=== itemName ? 'text-white bg-blue hover:bg-blue-hover border-none pl-8 pr-6 gap-x-3' : text-white w-16'}border-2 border-gray-300 rounded-full h-16 flex justify-center items-center`}
                  >
                    {name === itemName && (
